...
- **Instructions are generated, never hand-edited.** `scripts/generate-instructions.py` renders `output-styles/copydesk.md` and the reminder precis from the preset. Continuous integration runs `--check`.
